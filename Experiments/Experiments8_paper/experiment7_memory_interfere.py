...
#%% Pinv Fusion + MAN + Interfere
print('Pinv Fusion + MAN + Interfere')
result = {'Acc':[], 'TotalAcc':0}
name = 'PinvFusion+MAN=I'
Tasks = Tasks_initial(Tasks, Parm)
start = time.time()
Tasks = Fusion.Interfere_MAN_rank(Tasks, Parm, ifbatch=Parm.ifbatch)
fusion_net = Fusion.pinv_fusion(Tasks, fusion_net, Parm, ifbatch=Parm.ifbatch)
finish = time.time()
Parm.time[name] = finish - start
print(f"{name}: {Parm.time[name]}s")
...
#%% Pinv Fusion Weight + MAN + Interfere
print('Pinv Fusion Weight + MAN + Interfere')
result = {'Acc':[], 'TotalAcc':0}
name = 'PinvFusion_W+MAN+I'
Tasks = Tasks_initial(Tasks, Parm)
start = time.time()
Tasks = Fusion.Interfere_MAN_rank(Tasks, Parm, ifbatch=Parm.ifbatch)
fusion_net = Fusion.pinv_fusion(Tasks, fusion_net, Parm, ifbatch=Parm.ifbatch, ifweight=True)
...
record.record('./result/e7_1', Parm, 'pkl')