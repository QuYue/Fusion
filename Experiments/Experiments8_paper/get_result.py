...
for i in range(num):
    parm = Parm[i]
    Origin[i] = max(parm.result['Origin']['origin'][:time_length])
...
for i in range(num):
   parm = Parm[i]
   FusionFineTune[i] = max(parm.result['FusionNet']['FusionFineTune'][:time_length])
...
for i in range(num):
    parm = Parm[i]
    FusionKD[i] = max(parm.result['FusionNet']['FusionKD'][:time_length])
...
for i in range(num):
   parm = Parm[i]
   FusionMLKD[i] = max(parm.result['FusionNet']['FusionMLKD'][:time_length])
...
for i in range(num):
   parm = Parm[i]
   FusionFineTune[i] = max(parm.result['FusionNet']['FusionFineTune+AF'][:time_length])
...
for i in range(num):
   parm = Parm[i]
   FusionKD[i] = max(parm.result['FusionNet']['FusionKD+AF'][:time_length])
...
for i in range(num):
   parm = Parm[i]
   FusionMLKD[i] = max(parm.result['FusionNet']['FusionMLKD+AF'][:time_length])
...
for i in range(num):
   parm = Parm[i]
   FusionFineTune[i] = max(parm.result['FusionNet']['FusionFineTune+MAN'][:time_length])
...
for i in range(num):
   parm = Parm[i]
   FusionKD[i] = max(parm.result['FusionNet']['FusionKD+MAN'][:time_length])
...
for i in range(num):
   parm = Parm[i]
   FusionMLKD[i] = max(parm.result['FusionNet']['FusionMLKD+MAN'][:time_length])
